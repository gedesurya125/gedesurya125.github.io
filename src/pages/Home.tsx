  ...
  return (
    <div className="flex w-full items-center bg-gray-900">
      <div className="flex-1 pl-20">
        <h1>{AnimatedText({text: "Hi I'am Surya Adi", variant:"title", className:renderSubtitle ? "" : 'mb-7'})}</h1>
        {renderSubtitle ? <h1>{AnimatedText({text: "A Frontend Developer", variant:"subtitle", className:"text-xl pl-2 cursor-default"})}</h1> : null}
